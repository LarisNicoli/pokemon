...
export const Input = ({ onHandleSearch }: InputProps) => {
  ...
  return (
    <div className="absolute top-[70px] flex justify-center w-full">
      <div className="bg-white flex h-16 w-full md:w-1/2  justify-center items-center rouded-md p-3">
        <input
        ...
        <button
          ...
          className="h-full bg-blue-600 hover:bg-blue-400 w-16 flex justify-center items-center routed-md"
